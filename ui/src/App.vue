<template>
  <v-app id="inspire" >
    <v-navigation-drawer v-model="drawer" app      
      ...
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="text-h6"> MP3 Player </v-list-item-title>
      ...
      <v-list dense nav subheader>
        <v-subheader inset>Songs</v-subheader>

        <v-list-item-group>
          <v-list-item @click="modals.addSong.status = 1" color="primary">
            <v-list-item-icon>
        ...
        <v-subheader inset>Playlist</v-subheader>

        <v-list-item-group>
          <v-list-item @click="modals.addPlaylist.status = 1" color="primary">
            <v-list-item-icon>
          ...
          <v-list-item v-for="(currPlaylist, playlistKey) in playlists" :key="playlistKey">
            <v-list-item-icon class="ml-5">
              <v-icon small>mdi-folder-music</v-icon>
            </v-list-item-icon>
    ...
    <v-dialog v-model="modals.addSong.status" width="500">
      <v-card>
    ...
    <v-dialog v-model="modals.editSong.status" width="500">
      <v-card>
        <v-card-title class="text-h5 grey lighten-2"> Add Song </v-card-title>
    ...
    <v-dialog v-model="modals.addPlaylist.status" width="500">
      <v-card>
        <v-card-title class="text-h5 grey lighten-2"> Create Playlist </v-card-title>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" text @click="handleClickCreatePlaylist">
            Create
          </v-btn>
        </v-card-actions>
      </v-card>
